...
class SHControlPot(SHControl):
    ...
    def poll(self, ctrldef, ctrltype, ctrlstate, ctrlvalue):
        ...
        if ctrltype == 'toggle':
            ...
            state = SHContorlPot.__translateCalibratedValue(self, pot, controlsetup['calibration'][ctrltype])
            value = int(state)
            ...
            state = SHContorlPot.__translateCalibratedValue(self, pot, controlsetup['calibration']['words'])
            value = str(ctrldef['pool'][int(state)])
        return state
