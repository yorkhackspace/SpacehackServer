        ...
        if nodes[2]=='configure':
            ...
            if nodes[3] == 'enabled':
                if str(msg.payload) == "0":
                    ...
                    #switch it on
                    display(roundconfig['controls'][ctrlid]['name'], config['local']['controls'][ctrlid]['display']['width'], ctrlid)
            elif nodes[3] == 'name':
                display(str(msg.payload), config['local']['controls'][ctrlid]['display']['width'], ctrlid)
    elif nodes[0] == 'server':
        if nodes[1] == 'ready':
